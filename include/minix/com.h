...
/*===========================================================================*
 *                Messages for OBS server				     *
 *===========================================================================*/


#define OBS_BASE 0x1700

#define OBS_CANCEL_WATCH_EXIT (OBS_BASE+0)
#define OBS_WATCH_EXIT        (OBS_BASE+1)
#define OBS_PM_INFO          (OBS_BASE+2)
#define OBS_QUERY_EXIT        (OBS_BASE+3)
#define OBS_WAIT_EXIT         (OBS_BASE+4)

#define OBS_BY_PID        1
#define OBS_BY_ENDPOINT   2
#define OBS_INFO          1
#define OBS_DEAD_PROC     1
#define OBS_SIGNAL_INTR   2
